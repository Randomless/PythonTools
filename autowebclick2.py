...
@Author  :   Zhao Zhitao 
@software:   VS Code
@说明： 国科大教务系统-课程评估脚本（暂时只有点击）
@Desc    :   调用chromedirver.exe 打开chrome  
            step1：校园网下自动登录 手动打开到评教页面 点开一个评教课程
            step2：
            step3：每F5 Continue一下 即评估一个课程
'''
...
def click_buttons_part1_part3():
    browser.execute_script("window.scroll(0,220);") 
    buttons_xpath=['//*[@id="regfrm"]/table/tbody/tr[2]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[3]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[4]/td[1]/input',
                    
                    '//*[@id="regfrm"]/table/tbody/tr[6]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[7]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[8]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[9]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[10]/td[1]/input',
                    
                    '//*[@id="regfrm"]/table/tbody/tr[12]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[13]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[14]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[15]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[16]/td[1]/input',
                   ]
...
def click_buttons_part4_part5():
    ...
    buttons_xpath=[ '//*[@id="regfrm"]/table/tbody/tr[18]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[19]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[20]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[21]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[22]/td[1]/input',

                    
                    '//*[@id="regfrm"]/table/tbody/tr[24]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[25]/td[1]/input',
                    '//*[@id="regfrm"]/table/tbody/tr[26]/td[1]/input','//*[@id="regfrm"]/table/tbody/tr[27]/td[1]/input',
                    ]
    for item in buttons_xpath:
        if browser.find_element_by_xpath(item):
            input = browser.find_element_by_xpath(item).click()
